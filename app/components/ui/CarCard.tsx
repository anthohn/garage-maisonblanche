                        ...
                        <div className="grid grid-cols-3 gap-6 w-full">
                            ...
                            <div className="flex flex-col items-center text-center">
                                <div className="w-12 h-12 rounded-lg bg-blue-100 flex items-center justify-center mb-3">
                                    <svg className="w-6 h-6 text-[#303F9F]" fill="currentColor" viewBox="0 0 488.6 488.6">
                            ...
                            <div className="flex flex-col items-center text-center">
                                <div className="w-12 h-12 rounded-lg bg-blue-100 flex items-center justify-center mb-3">
                                    <svg className="w-6 h-6 text-[#303F9F]" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex flex-col items-center text-center">
                                <div className="w-12 h-12 rounded-lg bg-blue-100 flex items-center justify-center mb-3">
                                    <svg className="w-6 h-6 text-[#303F9F]" fill="currentColor" viewBox="0 0 122.88 122.88">
