                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-1">Service Rapide</h4>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-1">Diagnostic Précis</h4>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-1">Prix Transparents</h4>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-1">Relation Client</h4>
