                ...
                <>
                    ...
                    <div className="py-16 pt-32">
                        <div className="max-w-7xl mx-auto px-6 text-center">
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Tous nos véhicules</h1>
                            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                                Découvrez notre sélection complète de véhicules d&apos;occasion de qualité,
                                inspectés et garantis par nos soins
                            </p>
                        </div>
                    </div>
